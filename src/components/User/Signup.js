        ...
        <div className='flex justify-center items-center h-screen'>
            <div className="lg:w-96 w-[95%] md:w-96 max-w-96 ">
                <div className='shadow-lg p-4 rounded-md'>
                    <form className="bg-white  rounded  pt-6 pb-3 mb-2"
                        onSubmit={signupHamndler}
                    >
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className={`shadow appearance-none border ${nError ? 'border-red-500' : ''} rounded w-full py-3 px-3 text-gray-700 mb-3 leading-tight focus:outline-blue-500 focus:shadow-outline`}
                                type="text"
                                required
                                placeholder="Name" />
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                className={`shadow appearance-none border ${pError ? 'border-red-500' : ''} rounded w-full py-3 px-3 text-gray-700 mb-3 leading-tight focus:outline-blue-500 focus:shadow-outline`}
                                type="password"
                                required
                                placeholder="**************" />
                            {
